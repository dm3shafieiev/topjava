...
//        .toLocalDate();
//        .toLocalTime();
        List<UserMealWithExceed> expectedResult = Arrays.asList(
        ...
        if (!filteredWithExceeded.equals(expectedResult)) {
            throw new RuntimeException("Results aren't equal, recheck filterWithExceeded method logic");
        }
    }
